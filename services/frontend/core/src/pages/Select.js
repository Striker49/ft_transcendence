				...
				<div class="py-5 bg-info bg-opacity-50 border border-5 border-info rounded-5 text-black">
					<ul class="nav flex-column text-center">
						<li class="nav-item pt-1 pb-2 selected">
							...
							<div class="d-none">
								<a data-i18n-key="onePlayer" class="text-decoration-none text-black fw-bold fst-italic d-inline p-2" href="/gameConfig?nbPlayer=1" data-link>1 Player</a>
								<a data-i18n-key="twoPlayers" class="text-decoration-none text-black fw-bold fst-italic d-inline p-2" href="/gameConfig?nbPlayer=2" data-link>2 Players</a>
							</div>
						</li>
